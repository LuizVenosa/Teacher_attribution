...
Teacher attribution becomes much easier when multiple prompts are aggregated (Table~\ref{tab:setlevel}).
...
\begin{tabular}{rccc}
\toprule
Prompts & Acc. & Top-2 & AUC \\
\midrule
1 & 62.50 & 80.00 & 64.54 \\
2 & 73.75 & 92.50 & 83.67 \\
4 & 90.00 & 98.75 & 90.60 \\
8 & 97.50 & 100.00 & 96.15 \\
16 & 100.00 & 100.00 & 97.52 \\
32 & 100.00 & 100.00 & 99.33 \\
64 & 100.00 & 100.00 & 99.81 \\
\bottomrule
\end{tabular}
\caption{Set-level attribution improves as more prompts are aggregated. Results are sampled over prompt sets.}
\label{tab:setlevel}
\end{table}
